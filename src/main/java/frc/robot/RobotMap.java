...
public class RobotMap {
    ...
    */
    ...
    public static final int LEFT_FIRE_SOLENOID_1 = 14;
    public static final int LEFT_FIRE_SOLENOID_2 = 15;
    public static final int RIGHT_FIRE_SOLENOID_1 = 0;
    public static final int RIGHT_FIRE_SOLENOID_2 = 1;
